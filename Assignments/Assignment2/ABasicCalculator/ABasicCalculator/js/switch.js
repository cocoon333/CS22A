...
var calcu = function(calcValue) {
  ...
  switch (calcValue) {
    ...
    case "one":
      calc.output.value = calc.output.value + "1";
      break;
    case "two":
      calc.output.value = calc.output.value + "2";
      break;
    case "three":
      calc.output.value = calc.output.value + "3";
      break;
    case "four":
      calc.output.value = calc.output.value + "4";
      break;
    case "five":
      calc.output.value = calc.output.value + "5";
      break;
    case "six":
      calc.output.value = calc.output.value + "6";
      break;
    case "seven":
      calc.output.value = calc.output.value + "7";
      break;
    case "eight":
      calc.output.value = calc.output.value + "8";
      break;
    case "nine":
      calc.output.value = calc.output.value + "9";
      break;
    case "zero":
      calc.output.value = calc.output.value + "0";
      break;
    case "divide":
